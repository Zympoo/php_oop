...
class PostsRepository
{
     ...
     *
     * Doel:
     * Bewaart de PDO connectie zodat alle queries via dezelfde connectie
     * lopen.
     */
    ...
    {
        $sql = "SELECT id, title, status, created_at FROM posts ORDER BY id DESC";
    ...
    {
        $sql = "SELECT id, title, content, status, created_at FROM posts WHERE id = :id LIMIT 1";
