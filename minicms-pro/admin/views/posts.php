    ...
    <div class="bg-white p-6 rounded shadow">
        ...
        <table class="w-full text-sm">
            ...
            <?php foreach ($posts as $post): ?>
                <tr class="border-b">
                    <td class="py-2">
                        <a class="underline" href="/php/minicms-pro/admin/posts/<?php echo (int)$post['id']; ?>">
                            <?php echo
                    ...
                    <td class="text-right space-x-3">
                        ...
                        <?php if (Auth::isAdmin()): ?>
                            <a class="underline text-red-600" href="/php/minicms-pro/admin/posts/<?php
                            echo (int)$post['id']; ?>/delete">
                                Verwijderen
                            </a>
                        <?php endif; ?>
                    </td>
