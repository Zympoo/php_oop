...
class PostsController
{
    ...
    public function edit(int $id): void
    {
        ...
        View::render('post-edit.php', [
            ...
            'old' => [
                ...
                'categorie' => strtolower((string)$post['categorie_naam']),
            ],
        ]);
    }
    ...
    public function update(int $id): void
    {
        ...
        $content = trim((string)($_POST['content'] ?? ''));
        $status = (string)($_POST['status'] ?? 'draft');
        $categorie = (string)($_POST['categorie'] ?? 'tech');
        ...
        if(!in_array($categorie, ['tech', 'gaming', 'sport'], true)){
        ...
        $this->postsRepository->update($id, $title, $content, $status, $categorie);
