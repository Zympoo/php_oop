...
<section class="p-6">
    <div class="bg-white p-6 rounded shadow">
        ...
        <form method="post" action="/php/oef1/admin/posts/<?php echo (int)$postId; ?>/update" class="space-y-4">
            <div>
            ...
            <div>
                <label class="block text-sm font-bold mb-1" for="categorie">Categorie</label>
                <select class="w-full border rounded p-2" id="categorie" name="categorie">
                    <option value="tech" <?= (($old['categorie'] ?? 'tech') === 'tech') ? 'selected' : '' ?>>Tech</option>
                    <option value="sport" <?= (($old['categorie'] ?? '') === 'sport') ? 'selected' : '' ?>>Sport</option>
                    <option value="gaming" <?= (($old['categorie'] ?? '') === 'gaming') ? 'selected' : '' ?>>Gaming</option>
                </select>
            </div>
            ...
            <div class="flex gap-4">
                ...
                <a class="underline" href="/php/oef1/admin/posts">Terug</a>
            </div>
        </form>
    </div>
</section>
